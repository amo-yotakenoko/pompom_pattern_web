  ...
  return (
    <>
      ...
      >
        ...
        >
          <SizeSet value={rollWidth} valueSet={setRollWidth}></SizeSet>
        </div>
        <div
          style={{
            gridRow: "2",
        ...
        >
          <SizeSet value={pitchWidth} valueSet={setPitchWidth}></SizeSet>
        </div>
      </div>
