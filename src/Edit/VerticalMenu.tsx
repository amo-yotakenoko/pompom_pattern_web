...
const VerticalMenu = ({
  ...
  const cameraEnable = params.get("camera") !== "disable";
  const decorationEnable = params.get("decoration") !== "disable";
  ...
  return (
    <>
      ...
      >
        <Item
          displayName={
            <div id={"editMenu"} style={{ textAlign: "center" }}>
              {" "}
              <Icon.PencilSquare />
              編集{" "}
            </div>
        ...
        {cameraEnable && (
          <Item
            displayName={
              <div id={"cameraScanMenu"} style={{ textAlign: "center" }}>
                {" "}
                <Icon.Camera />
                カメラ{" "}
              </div>
            ...
            activeMenu={activeMenu}
            setActiveMenu={setActiveMenu}
            isDisabled={activeMenu == "cameraScan"}
          ></Item>
        )}
        {decorationEnable && (
          <Item
            displayName={
              <div id={"decorationMenu"} style={{ textAlign: "center" }}>
                {" "}
                <Icon.Stars />
                装飾{" "}
              </div>
        ...
        <Item
          displayName={
            <div id={"blueprintMenu"} style={{ textAlign: "center" }}>
              {" "}
        ...
        {activeMenu != "pompom" && (
          <Help id="editMenu" placement="left">
            ペンモード
          </Help>
        )}
        {activeMenu != "cameraScan" && (
          <Help id="cameraScanMenu" placement="left">
            カメラモード
          </Help>
        )}
        {activeMenu != "decoration" && (
          <Help id="decorationMenu" placement="left">
            装飾
          </Help>
        )}
        {activeMenu != "bluePrint" && (
          <Help id="blueprintMenu" placement="left">
            完成したらこちら
          </Help>
        )}
